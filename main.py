...
class Inventory:
    def __init__(self):
        ...
        self.add_item=Button(self.body_frame,text="Add Item  ",font="Times 22 bold",image=self.add_item_img,compound="right",bg=background,fg=foreground,bd=0,activebackground=background)
        self.add_item.grid(row=0,column=0,pady=25)
        self.add_rawitem=Button(self.body_frame,text="Add Raw  \nItem  ",font="Times 22 bold",image=self.raw_item_img,compound="right",bg=background,fg=foreground,bd=0,activebackground=background)
